...
from vdmarl.utils import DEVICE_TYPING
...
class Lstm(Model):
    ...
    The VDMARL LSTM accepts multiple inputs of type array: Tensors of shape ``(*batch,F)``
...
class LstmConfig(ModelConfig):
    """Dataclass config for a :class:`~vdmarl.models.LSTM`."""
