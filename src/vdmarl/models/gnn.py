...
from vdmarl.models.common import Model, ModelConfig
...
class Gnn(Model):
    ...
    Args:
        ...
        position_key (str, optional): if provided, it will need to match a leaf key in the tensordict coming from the env
            ...
            If you want to use this feature in a :class:`~vdmarl.models.SequenceModel`, the GNN needs to be first in sequence.
...
class GnnConfig(ModelConfig):
    """Dataclass config for a :class:`~vdmarl.models.Gnn`."""
