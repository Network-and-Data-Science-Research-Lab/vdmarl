...
from vdmarl.utils import _class_from_name, _read_yaml_config, DEVICE_TYPING
...
class Model(TensorDictModuleBase, ABC):
    ...
    Models in VDMARL are instantiated per agent group.
...
class SequenceModel(Model):
    """A sequence of :class:`~vdmarl.models.Model`
...
class ModelConfig(ABC):
    """
    Dataclass representing a :class:`~vdmarl.models.Model` configuration.
    ...
    def get_from_yaml(cls, path: Optional[str] = None):
        ...
        Args:
            path (str, optional): The full path of the yaml file to load from.
                ...
                vdmarl/conf/model/layers/self.associated_class().__name__
...
class SequenceModelConfig(ModelConfig):
    """Dataclass for a :class:`~vdmarl.models.SequenceModel`.
    ...
    Examples:
          ...
          .. code-block:: python
            ...
            from vdmarl.models import SequenceModelConfig, GnnConfig, MlpConfig
