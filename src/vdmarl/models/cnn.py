...
class Cnn(Model):
    ...
    The VDMARL CNN accepts multiple inputs of 2 types:
    ...
    def _forward(self, tensordict: TensorDictBase) -> TensorDictBase:
        ...
        # VDMARL images are X,Y,C -> we convert them to C, X, Y for processing in TorchRL models
...
class CnnConfig(ModelConfig):
    """Dataclass config for a :class:`~vdmarl.models.Cnn`."""
